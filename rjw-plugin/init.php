...
require_once('inc/style-login.php');
	...
	// Makes WooCommerce not require state because other countries still have to fill it out and the field is missing
if(isset($a['rjw_checkbox_field_state_not_required']) && $a['rjw_checkbox_field_state_not_required'] === '1'){
require_once('inc/state-not-required.php');
}else{
	}
